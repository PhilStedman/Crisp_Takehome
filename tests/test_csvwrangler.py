...
def test_samplecsv_withcfg():
    ...
    expected = [ csvwrangler.Order( 1000, datetime.datetime(2018,1,1), "P-10001", "Arugola", 5250, "lbs" ),
                 csvwrangler.Order( 1001, datetime.datetime(2017,12,12), "P-10002", "Iceberg Lettuce", 500, "lbs" ) ]
